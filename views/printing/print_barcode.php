	...
	<tr><td colspan=10 style="text-align:right;font-size:12px;"><span style="text-align:right;" ><?php echo $item_short ; ?></span></td>	
			</tr>
		...
		<tr>
			<td colspan=5 style="font-family:Arial;text-align:left;font-size:12px;font-weight: bold;" nowrap="nowrap" ><span class="font_english">&nbsp;&nbsp;<?php echo $supplier_code; ?>-<?php echo $item_model; ?></span></td>
