...
class blood_groups extends Base_Controller
 {
	...
	function __construct()
	{
        ...
        $this->concept  = "blood_group" ; 
        $this->controller = "clinic/blood_groups";    
        
        $this->class_name    = "bi_blood_group" ; 
        $this->class_path =  "clinic/bi_blood_group" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "blood_group_id"; 
        
        $this->use_lang_files = array("clinic/blood_group_main") ; 
        $this->security_component = "security.blood" ; 
...
//---------------------------------------------------------------
	public function ajax_table()
	{
        ...
        $data["this_lang_file"] = "clinic/blood_group_main" ; 	
		$data["this_id_field"] = "blood_group_id" ; 
		$data["this_name_field"] = "blood_group_type" ; 
		$data["this_name_field_ar"] = "blood_group_type" ;
...
//---------------------------------------------------
	...
	//	echo $this->concept ; 
		...
		$this->form_validation->set_rules("blood_group_type","blood group type", "required") ;
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$this->load->view('clc_edit/blood_group_edit',$data);	
			return ; 
		}
