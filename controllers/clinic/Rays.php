...
class rays extends Base_Controller
 {
	...
	function __construct()
	{
        ...
        $this->concept  = "rays" ; 
        $this->controller = "clinic/rays";    
        
        $this->class_name    = "bi_rays" ; 
        $this->class_path =  "clinic/bi_rays" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "rays_id"; 
...
//---------------------------------------------------------------
	public function ajax_table()
	{
		...
		$data["this_concept"] = "rays" ;
		$data["this_controller"] = $this->controller; 

        $data["this_lang_file"] = "clinic/rays_main" ; 	
		$data["this_id_field"] = "rays_id" ; 
		$data["this_name_field"] = "rays_type" ; 
		$data["this_name_field_ar"] = "rays_type" ;
...
//---------------------------------------------------
	...
	//	echo $this->concept ; 
		...
		$this->form_validation->set_rules("rays_type","rays type", "required") ;
		$this->form_validation->set_rules("rays_description","rays description", "required") ;
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$this->load->view('clc_edit/rays_edit',$data);	
			return ; 
		}
			 ...
			 */
				...
				//	$this_item->business_data["drug_available"] = 0 ; //it's for check-box when it's unchecked return 0
					...
					if ($this_item->success==FALSE)
					{
						...
						echo "<b><center>Rays is already exist</center></b>";
