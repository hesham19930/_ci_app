...
function __construct()
    {
        ...
        $this->concept  = "service" ; 
        $this->controller = "clinic/services";    
        
        $this->class_name    = "bi_service" ; 
        $this->class_path =  "clinic/bi_service" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "service_id"; 
        
        $this->use_lang_files = array("clinic/service_main") ; 
        $this->security_component = "security.service" ; 
...
//---------------------------------------------------------------
	public function ajax_table()
	{
		...
		$sys_acc_id = $this->admin_public->DATA["sys_account_id"];
		
		//$data["list_table"] = $this_item->list_items_rtable( "all",array() ,"");
		$data["list_table"] = $this_item->list_items_rtable( "single_acc", array("sys_account_id"=> $sys_acc_id ) ,"");
		//$data["list_table"] = $this_item->list_items_rtable("single_account" , array() , "" , "default");
		...
		//$data["options"]["show_box_title"] = "SERVICES" ; 
	...
	//	echo $this->concept ; 
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$data["public_data"] = $this->admin_public->DATA;
			$data["disable_edit"] = false;//try to true						
			$this->load->view( 'clc_edit/service_edit',$data);	
			return ; 
		}
			 ...
			 */
				...
				//	$this_item->business_data["drug_available"] = 0 ; //it's for check-box when it's unchecked return 0
					...
					else
					{
						...
						$this_item->business_data["service_sys_account_id"] = $this->admin_public->DATA["sys_account_id"];
