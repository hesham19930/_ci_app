...
<div class="footer hide_with_menu" >
	...
	<script type="text/javascript" src="<?php echo base_url($themefolder);?>/assets/plugins/jquery-multi-select/js/jquery.multi-select.js"></script> 
	
	
	
	
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script type="text/javascript" src="<?php echo base_url($themefolder);?>/assets/plugins/select2/select2.min.js"></script>
