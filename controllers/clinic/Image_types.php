...
class image_types extends Base_Controller
 {
	...
	function __construct()
	{
        ...
        $this->concept  = "image_type" ; 
        $this->controller = "clinic/image_types";    
        
        $this->class_name    = "bi_image_type" ; 
        $this->class_path =  "clinic/bi_image_type" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "image_type_id"; 
        
        $this->use_lang_files = array("clinic/image_type_main") ; 
        $this->security_component = "security.type_image" ; 
...
//---------------------------------------------------------
	public function ajax_table()
	{
		...
		$data["this_concept"] = "image_type" ;
		$data["this_controller"] = $this->controller; 

        $data["this_lang_file"] = "clinic/image_type_main" ; 	
		$data["this_id_field"] = "image_type_id" ; 
		$data["this_name_field"] = "image_type_name" ; 
		$data["this_name_field_ar"] = "image_type_name" ;
...
//---------------------------------------------------
	...
	//	echo $this->concept ; 
		...
		$this->form_validation->set_rules("image_type_name","image_type_name", "required") ;
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$this->load->view('clc_edit/image_type_edit',$data);	
			return ; 
		}
			 ...
			 */
				...
				//	$this_item->business_data["drug_available"] = 0 ; //it's for check-box when it's unchecked return 0
					...
					if ($this_item->success==FALSE)
					{
						...
						echo "<b><center>This image_type is already exist</center></b>";
