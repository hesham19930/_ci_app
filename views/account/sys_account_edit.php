<?php
	...
	$this_concept = "sys_account" ; 
	$this_controller = "account/".$this_concept."_s";
	...
	$input_values = array() ; // this is our array 
		...
		r_theme_InputText($field_name,$input_values[$field_name],$Label , "meduim",$SubTip ,$read_only);
		//_____________________________________________________________________________________________
		$field_name = "sys_account_title_ar" ;
		...
		$field_name = "sys_acc_admin_email" ;
		...
		$field_name = "sys_acc_is_active" ; //check box
		...
		echo '</div></div>';
		//___________________________________________________________________________________
		$field_name = "sys_acc_type" ;
		 
		$SubTip = r_langline($field_name.'_tip',$lang_section)." ";
		if (form_error($field_name)!=""){	$SubTip = r_theme_input_error(r_langline($field_name.'_is_required',$lang_section));	}
		$Label = r_langline($field_name.'_label',$lang_section);
		
		//r_theme_InputText($field_name,$input_values[$field_name],$Label , "meduim",$SubTip ,1);
		r_theme_InputHidden($field_name,$input_values[$field_name],$Label , "meduim",$SubTip ,1);
		//_____________________________________________________________________________________________
		$field_name = "sys_acc_remarks" ;
		...
		$field_name = "sys_acc_enable_logo" ;
		...
		$field_name = "sys_acc_date_created" ;
		...
		//_____________________________________________________________________________________________
			...
			$field_name = "sys_acc_dep_id" ; 
		
			$SubTip = r_langline($field_name.'_tip',$lang_section)." ";
			if (form_error($field_name)!=""){	$SubTip = r_theme_input_error(r_langline($field_name.'_is_required',$lang_section));	}
			$Label = r_langline($field_name.'_label',$lang_section);
			
			$lookup_class= "bi_department" ; 
			$lookup_filter="" ; 	
