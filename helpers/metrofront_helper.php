...
if ( ! function_exists('r_theme_page_title'))
{
	function r_theme_page_title($page_title, $bread_crumbs= '')
	{
		?>
		<!-- BEGIN BREADCRUMBS -->   
	    <div class="row-fluid breadcrumbs margin-bottom-40">
	        <div class="container">
	            <div class="span4 arabic_font">
...
if ( ! function_exists('r_theme_message'))
{
	function r_theme_message($iStyle,$iTitle,$iMessage , $iWithBox=0,$iBoxTitle="")
	{
		...
		echo 'METROFRONT<strong>'.$iTitle.'</strong> : ';
		echo $iMessage.'</div>';
		echo "</div></div>";
