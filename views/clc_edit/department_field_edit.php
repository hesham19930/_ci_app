<?php
	...
	if ( ($use_item_info==true)OR(set_value("is_an_action") != "yes"))
		...
		if ( $item->ID()!=0)
		{
			$field_name = "department_field_id" ;
		...
		echo '<div class="span5 m-wrap">';
		   ...
		   $field_name = "department_NAME" ;
				...
				r_theme_InputText($field_name,$input_values['department_NAME'],$Label , "large",$SubTip ,1);
	...
	/*	//--------------------------------------------------------------------------------------------------------
		...
		*/
		...
		echo '<div class="span5 m-wrap">';
		   ...
		   $field_name = "df_lookup_class_name" ;
					$SubTip = r_langline($field_name.'_tip',$lang_section)." ";
					if (form_error($field_name)!=""){	$SubTip = r_theme_input_error(r_langline($field_name.'_is_required',$lang_section));	}
					$Label = r_langline($field_name.'_label',$lang_section);
					...
					$classname["bi_air_line"] = "Air Line" ;
					
					
					r_theme_InputSelect($field_name , $input_values[$field_name ], $Label,$classname,"4",$SubTip,$read_only,0);
	...
	/**	
		...
		$field_name = "is_totalamount_field" ;
		...
		$field_name = "is_unit_price_field" ;
	 ...
	 */
		...
		$field_name = "df_lookup_class_filter" ;
