...
Class bi_department extends Simple_business implements iSimple_Business 
	{
...
//-------------------------------------------------
	...
	public function bi_config()
	{
			...
			$CI->lang->load("clinic/department_main",$lang);
		
		//create the class stamp -------------------------------------------
		
			$this->class_name="bi_department";
			$this->table_name="department_s";
			
			$this->concept_key="department." ; 
			
			$this->id_field_name="department_id" ; 
			
			$this->name_field_name=r_langcase("department_name","department name");
			$this->name_field_name="department_name" ;
			...
			$this->list_views["default"] = Array (
				"department_id"=>r_langline("default.list.department_id",$this->concept_key) , 
				"department_name"=>r_langline("default.list.department_name",$this->concept_key),
				"department_code"=>r_langline("default.list.department_code",$this->concept_key),
				"_DETAILS"=>"|hide|" ,
		...
		//---------------------------------------------------------- ---------------------------
			...
			$this->read_select = Array("department_s.*");		
			$this->read_select_extended=Array("department_s.*");
...
//////////////////////////////////////////////////////////////
	...
	{		
		$repeat_id =  $this->check_value_exist(array("department_name"=>$this->business_data["department_name"]),0,1) ;
		if ($repeat_id !=0 )
			{  
