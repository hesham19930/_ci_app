...
class Visit_types extends Base_Controller
 {
    ...
    function __construct()
    {
        ...
        $this->concept  = "visit_type" ; 
        $this->controller = "clinic/visit_types";    
        
        $this->class_name    = "bi_visit_type" ; 
        $this->class_path =  "clinic/bi_visit_type" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "visit_type_id"; 
        
        $this->use_lang_files = array("clinic/visit_type_main") ; 
        $this->security_component = "security.visit_type" ; 
...
//----------------------------------------------------------------
    public function ajax_table()
    {
        ...
        $data["this_concept"] = "visit_type" ;
        $data["this_controller"] = $this->controller; 

        $data["this_lang_file"] = "clinic/visit_type_main" ;    
        $data["this_id_field"] = "visit_type_id" ; 
        $data["this_name_field"] = "visit_type_name" ; 
        $data["this_name_field_ar"] = "visit_type_name" ;
...
//---------------------------------------------------
    ...
    // load & read Existing object  ----------------------------------------------------
        ...
        $data["this_controller"] = $this->controller;   
    //  echo $this->concept ; 
    $this->form_validation->set_rules("is_an_action","", "required") ;
        ...
        if ($this->form_validation->run() == FALSE )
        {
            ...
            $this->load->view('clc_edit/visit_type_edit',$data);    
            return ; 
        }
