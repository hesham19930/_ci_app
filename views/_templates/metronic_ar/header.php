...
<head>
	...
	<!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="<?php echo base_url($themefolder);?>/assets/plugins/bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url($themefolder);?>/assets/plugins/bootstrap/css/bootstrap-responsive-rtl.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?php echo base_url($themefolder);?>/assets/css/style-metro-rtl.css" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url($themefolder);?>/assets/css/style-rtl.css" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url($themefolder);?>/assets/css/style-responsive-rtl.css" rel="stylesheet" type="text/css"/>
	...
	<link rel="stylesheet" href="<?php echo base_url($themefolder);?>/assets/plugins/data-tables/DT_bootstrap_rtl.css" />
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<!--<li><a href="extra_lock.html"><i class="icon-lock"></i> Lock Screen</a></li>-->
							 <li><a href="<?php echo site_url("account/dashboard/change_lang/english") ; ?>" ><i class="icon-flag"></i>English</a></li>
