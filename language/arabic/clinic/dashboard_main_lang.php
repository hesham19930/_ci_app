...
// Master View Section -----------------------------------------------------------------------------------------
	...
	$lang[$section.'waiting_to_arrive']="فى انتظار الوصول";
	$lang[$section.'already_arrived']="تم الوصول";

	
//---tabs -------------
	$lang[$section.'appointments_schedule']="حجوزات الشهر";
	$lang[$section.'today_appointments']="حجوزات اليوم";	
	$lang[$section.'patient_find']="بحث مريض";
