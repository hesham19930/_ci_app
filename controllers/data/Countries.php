...
class countries extends CI_Controller {
	...
	public $concept  = "country" ; 
	public $controller = "data/countries";  	
		
	public $class_name    = "bi_country" ; 
	public $class_path =  "data/bi_country" ; 
	...
	public function ajax_edit()
	{
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$this->load->view('edit_forms/country_edit',$data);	
			return ; 
		} 
		...
		else 
		{
			...
			$this_item->business_data["COUNTRY_ONHOLD"] = 0 ;
	...
	public function ajax_table($purpose="" , $show_box = 'no')
	{
		...
		$data["this_controller"] = $this->controller ; 		
		$data["this_lang_file"] = $this->lang_file ; 
		$data["this_id_field"] = "COUNTRY_ID" ; 
		$data["this_name_field"] = "COUNTRY_NAME" ; 
		$data["this_name_field_ar"] = "COUNTRY_NAME" ;
		...
		$this->load->helper($this->theme_helper)	;
               ...
               if ( $show_box == 'yes' )
                 {
                         r_theme_box_start(r_langline('list_title',"country.master."),12,
							array("body_id"=>"country_list_body",
									"box_id"=>"country_list_box",
									"tools"=>"reload"	,
