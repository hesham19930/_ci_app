...
//r_theme_InputDate($field_name, $input_values[$field_name], $Label, "meduim", $SubTip, $read_only);
echo '</div></div>';
...
$field_name = "project_estimated_days";
