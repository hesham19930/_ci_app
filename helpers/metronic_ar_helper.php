...
if ( ! function_exists('r_theme_draw_table'))
{
    function r_theme_draw_table( rTable $iTable ,array $i_options=array(),$i_table_id="datatable_1",array $i_line_vers=array(),$split_buttons =0,$total_these =array()  
        ...
        echo '<span width=100%  id="one_print_header"></span>' ;
        ...
        style="borxder-left: #333 2px solid;border-xright: #333 2px solid;border-top: #333 2px solid;border-bottom: #333 2px solid;" 
        > ';
        ...
        if ($header_html!="")
        {
            echo '<tr class="hide_with_menu hide" ><th colspan=30  id="table_print_header"  ><div  ></div></th></tr>' ;       
        }
        
        echo '<tr  id="player"  style="color:white;"  class="portlet box '.$header_color.' " 
...
if ( ! function_exists('r_theme_box_start'))
{
    function r_theme_box_start($iTitle="",$i_width = 12,$i_options = array()) {
        ...
        echo '<div class="portlet '.$make_box.' '.$back_color ;
        ...
        if ($iTitle!="")
        {
                ...
                if (in_array("collapse", $tools)) echo '    <a href="javascript:;" class="collapse"></a> ' ; 
        ...
        */
        ...
        echo '<div style="background-color: #FFFFFF;'.$heightstring.' " class="portlet-body  fxxlip-scroll '.$add_to_class.'" id="'.$body_id.'" '.$add_to_attrib.' >';
    }
}
...
if ( ! function_exists('r_theme_inputtext'))
{
        function r_theme_inputtext($iName, $iValue, $iLabel, $iLenght = "medium", $iSubTip = "", $iReadOnly = 0,$control_only=0,$with_label=1 , $thurl="" ) {
          ...
          if ($control_only == 0 ) {echo '<div class="controls input-icon master_font">';} 
            ...
            echo '<input type="text" placeholder="" class="m-wrap '.$iLenght.' master_font " value="' . $iValue . '" name="' . $iName . '" id="'.$iName.'" ';
...
if ( ! function_exists('r_theme_inputtext_mask'))
{
        function r_theme_inputtext_mask($iName, $iValue, $iLabel, $iLenght = "medium", $iSubTip = "", $iReadOnly = 0,$maskclass) {
            ...
            <div class="control-group">
                <label class="control-label master_font" for="'.$iName.'">'.$iLabel.'</label>
                <div class="controls input-icon">
                    <input stxyle="direction:ltr;text-align:right;" type="text" placeholder="" class="m-wrap '.$iLenght.' '.$maskclass.'" value="' . $iValue . '" name="' . $iName . '" id="'.$iName.'" ';
            if ($iReadOnly == 1) {echo 'readonly="readonly" ';}
            echo '/>
            ' ; 
            if ($iSubTip!="")
...
if ( ! function_exists('r_theme_input_textlabel'))
{
    ...
    {   
        ...
        if ($iReadOnly != 1) { echo 'select2_combo  ' ; } 
        echo 'm-wrap  '.$iLenght.'" tabindex="1" name="' . $iName . '" ';
        echo ' id="'.$iName.'" ' ;
        if ($iReadOnly == 1) {
        ?>
         disabled="disbaled"   
    ...
    function r_theme_InputSelect_Normal($iName, $iValue, $iLabel, $iData, $iLenght = 5, $iSubTip = "", $iReadOnly = 0) {
            ...
            echo '<div class="control-group">
                    <label class="control-label master_font">'.$iLabel.'</label>
                    <div class="controls">
                    <select class="m-wrap '.$iLenght.'" value="' . $iValue . '" name="' . $iName . '"  tabindex="1" ';
            echo ' id="'.$iName.'" ' ;
            if ($iReadOnly == 1) {
    ...
    function r_theme_InputArea($iName, $iValue, $iLabel, $iLenght = 5, $iSubTip = "", $iReadOnly = 0) {
            ...
            <div class="control-group">
                <label class="control-label master_font" for="'.$iName.'">'.$iLabel.'</label>
                <div class="controls input-icon">
                    <textarea class="large m-wrap" rows="3" value="' . $iValue . '" name="' . $iName . '" id="'.$iName.'" ';
