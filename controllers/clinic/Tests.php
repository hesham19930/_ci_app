...
class tests extends Base_Controller
 {
	...
	function __construct()
	{
        ...
        $this->concept  = "test" ; 
        $this->controller = "clinic/tests";    
        
        $this->class_name    = "bi_test" ; 
        $this->class_path =  "clinic/bi_test" ; 
 
        $this->view_folder = "clinic"; 
        $this->id_field  = "test_id"; 
        
        $this->use_lang_files = array("clinic/test_main") ; 
...
//---------------------------------------------------------------
	public function ajax_table()
	{
		...
		$data["this_concept"] = "test" ;
		$data["this_controller"] = $this->controller; 

        $data["this_lang_file"] = "clinic/test_main" ; 	
		$data["this_id_field"] = "test_id" ; 
		$data["this_name_field"] = "test_name" ; 
		$data["this_name_field_ar"] = "test_name" ;
...
//---------------------------------------------------
	...
	$this->load->model('lookup/bi_test_type');
	...
	//	echo $this->concept ; 
		...
		if ($this->form_validation->run() == FALSE )
		{
			...
			$this->load->view('clc_edit/test_edit',$data);	
			return ; 
		}
