	<?php
	 ...
	 //	if ($this_item->ID()==0) { $this_title = $this_title." NEW ";} else { $this_title = $this_title . $this_item->ID();} 
		...
		$public_data["page_title"] = "Department Setup" ; 
		...
		r_theme_section_start(12,array("id"=>$this_concept."_edit_section","attributes"=>array(
									  'class'=>'autoload' ,
		'url'=>site_url($this_controller.'/ajax_edit/'.$this_item->ID()."/view_only" ))));	
		...
		r_theme_section_start(12,array("id"=>"department_field_edit_section","attributes"=>array('class'=>'modal transparent container hide' )));									  
		...
		?>
		<div class="table-toolbar hide_with_menu " style="backgxround-color: #f0f7f0;padding:1px;borxder: 1px #DDD solid;"  >
			<div class="btn-group pull-left">
				...
				caller_verb="add_department_field"
				caller_id="new_department_field_button"
				caller_url= "" 
				caller_target="department_field_edit_section"
		...
		if (!$this_item->ID()==0)
		{
		   	...
		   	r_theme_section_start(12,array("id"=>"department_field_list_section","attributes"=>array(
										  'class'=>'autoload' ,
										  'url'=>site_url("clinic/department_fields/ajax_table/".$department_id)) ) );	
	...
	<!-- in case the transaction is new dont show details & respond to saving by reloding details --> 
		...
		<a class="r_automation"  caller_key = "new_department_field_button" automation_verb="add_department_field"
			automation_action ="load_form_modal"
		
			automation_target = "department_field_edit_section"			
			automation_url="<?php echo site_url('clinic/department_fields/ajax_edit/0/'.$this_item->ID()) ; ?>"   
			
		></a>
		
	
		
		<a class="r_automation" 	caller_key = "department_field_table" automation_verb="edit" 
			automation_target ="department_field_edit_section"  
			automation_action ="load_form_modal"
			automation_url="[get_from_caller]"   
		></a>		
	
		<a class="r_automation" caller_key = "department_field_edit_form" automation_verb="post_form"
		...
		<a class="r_automation" caller_key = "department_field_edit_form"  automation_verb="form_post_success"		
			automation_target ="department_field_edit_section"
		...
		<a class="r_automation"  caller_key = "department_field_edit_form"  automation_verb="form_post_success"
			automation_target = "department_field_list_section" 
		...
		<a class="r_automation" caller_key = "department_field_edit_form"  automation_verb="form_cancel"
			automation_target ="department_field_edit_section"
			automation_action ="clear_modal"
			automation_url=""   
		></a>
		...
		<a class="r_automation"  caller_key = "department_field_table"  automation_verb="delete"
		...
		<a class="r_automation" caller_key = "department_field_delete_form" automation_verb="post_form"
			automation_target ="[get_from_caller]"   
			automation_action ="post_form"
			automation_url="[get_from_caller]"   
		></a>
		
		<a class="r_automation" caller_key = "department_field_delete_form" automation_verb="form_post_success"
			automation_target = "department_field_list_section" 
			automation_action ="reload"
			automation_url=""   
		></a>	
