...
Class bi_blood_group extends Simple_business implements iSimple_Business 
	{
...
//-------------------------------------------------
	...
	public function bi_config()
	{
		...
		//create the class stamp -------------------------------------------
			...
			$this->class_name="bi_blood_group";
			$this->table_name="blood_group_s";
			
			$this->concept_key="blood_group." ; 
			
			$this->id_field_name="blood_group_id" ; 
			
			$this->name_field_name=r_langcase("blood_group_type","blood_group_type");
			$this->name_field_name="blood_group_type" ;
			...
			$this->list_views["default"] = Array (
				"blood_group_id"=>r_langline("default.list.blood_group_id",$this->concept_key) , 
				"blood_group_type"=>r_langline("default.list.blood_group_type",$this->concept_key),
				"blood_group_description"=>r_langline("default.list.blood_group_description",$this->concept_key),
		...
		//---------------------------------------------------------- ---------------------------
			...
			$this->read_select = Array("blood_group_s.*");		
			$this->read_select_extended=Array("blood_group_s.*");
...
//////////////////////////////////////////////////////////////
	...
	{		
		$repeat_id =  $this->check_value_exist(array("blood_group_type"=>$this->business_data["blood_group_type"]),0,1) ;
		if ($repeat_id !=0 )
			{  
