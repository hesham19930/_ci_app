...
Class bi_evaluation_form extends Simple_business implements iSimple_Business 
	{
...
//-------------------------------------------------
	...
	public function bi_config()
	{
			...
			$CI->lang->load("clinic/evaluation_form_main",$lang);
		
		//create the class stamp -------------------------------------------
		
			$this->class_name="bi_evaluation_form";
			$this->table_name="evaluation_form_s";
			
			$this->concept_key="evaluation_form." ; 
			
			$this->id_field_name="evaluation_form_id" ; 
			
			$this->name_field_name=r_langcase("evaluation_form_name","evaluation name");
			$this->name_field_name="evaluation_form_name" ;
			...
			$this->list_views["default"] = Array (
				"evaluation_form_id"=>r_langline("default.list.evaluation_form_id",$this->concept_key) , 
				"evaluation_form_name"=>r_langline("default.list.evaluation_form_name",$this->concept_key),
				"evaluation_form_description"=>r_langline("default.list.evaluation_form_description",$this->concept_key),
				"_details"=>"|hide|" ,
		...
		//---------------------------------------------------------- ---------------------------
			...
			$this->read_select = Array("evaluation_form_s.*");		
			$this->read_select_extended=Array("evaluation_form_s.*");
...
//////////////////////////////////////////////////////////////
	...
	{		
		$repeat_id =  $this->check_value_exist(array("evaluation_form_name"=>$this->business_data["evaluation_form_name"]),0,1) ;
		if ($repeat_id !=0 )
			{  
