<?php
    ...
    $input_values = array() ; // this is our array 
       ...
       if ($disable_edit) $read_only = 1 ; 
        ...
        if (      $input_values["visit_v_status_id"] ==4) $title = "CANCEL APPOINTMENT" ;
        if (      $input_values["visit_v_status_id"] ==2) $title = "ARRIVAL OF  APPOINTMENT" ;
        ...
        $lookup_class= "bi_visit_type" ; 
                ...
                r_theme_InputSelect($field_name , $input_values[$field_name ], $Label,r_listbox_items($lookup_class,$lookup_filter),"3",$SubTip,0,0);
                    ...
                    $field_name = "visit_weight" ;
                        ...
                        $SubTip = "" ;  
                        $Label ="Weight :" ;
                                 r_theme_InputText($field_name,$input_values[$field_name],$Label , "small",$SubTip ,0);
    ...
    //    echo '</div></div>';
        ...
        <div class="btn-group">
            ...
            caller_id="change_status_form"
            caller_url= "<?php echo site_url('clinic/visits/change_status') ; ?>"
        ...
        if ( $read_only!=1) 
        {
            ?>
         <?php
              if ($input_values["visit_v_status_id"]==4) {
                  echo "<span style='color:red;' > YOU WILL NEED TO REFRESH SELECTION</span>" ;
              } 
        ?>      
        <div class="btn-group">
        <button  
            ...
            <?php 
            if ($input_values["visit_v_status_id"]==2) echo "ARRIVE " ;
            if ($input_values["visit_v_status_id"]==4) echo "CANCEL APPOINTMENT" ; 
            
            //echo r_langline("general.button_save") ; 
            ?>
        </button>
